      ...
      itemBuilder: (context, index) {
        return ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            ...
            backgroundColor: widget.from + index == selectedNumber ? AppColors.primary : AppColors.surface,
            foregroundColor: widget.from + index == selectedNumber ? AppColors.surface : AppColors.textColor,
          ),
